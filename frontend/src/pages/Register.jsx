...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast("Welcome to Shortly! Account created successfully. 🎉", "success");
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl p-8 shadow-2xl shadow-black/40">
              ...
              <div className="mb-6">
                ...
                <p className="mt-1.5 text-sm text-gray-400">
                  Get started and manage your short links.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 block" htmlFor="name">
                    Full Name
                  </label>
                ...
                >
                  {loading ? (
                    <>
                      ...
                      <span>
                        {serverWaking ? "Waking up server…" : "Creating your account…"}
                      </span>
                    </>
                  ) : (
                    <span>Sign Up</span>
