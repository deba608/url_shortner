          ...
          >
            ...
            <div className="hidden md:flex items-center gap-3">
              {isAuthenticated ? (
                ...
                <>
                  <Button variant="secondary" size="sm" onClick={() => navigate(ROUTES.LOGIN)}>Login</Button>
            ...
            {isAuthenticated ? (
              ...
              <div className="flex flex-col gap-2">
                <button
                  ...
                  className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-semibold text-gray-300 hover:bg-white/5 transition-colors border border-white/10"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-semibold text-indigo-400 bg-indigo-500/10 hover:bg-indigo-500/20 transition-colors"
                >
